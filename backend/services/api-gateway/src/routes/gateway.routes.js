...
const gatewayRoutes = [
  {
    ...
    routes: [
      { path: "/auth/register", proxyRoot: "/auth", upstream: "/auth", public: true },
      { path: "/auth/login", proxyRoot: "/auth", upstream: "/auth", public: true },
      { path: "/auth/refresh-token", proxyRoot: "/auth", upstream: "/auth", public: true },
      { path: "/auth/forgot-password", proxyRoot: "/auth", upstream: "/auth", public: true },
      { path: "/auth/verify-reset-code", proxyRoot: "/auth", upstream: "/auth", public: true },
      { path: "/auth/reset-password", proxyRoot: "/auth", upstream: "/auth", public: true },
